...
import { GitDraftProvider } from './git/GitDraftProvider'
 ...
 *   FileTreeStateProvider   … Files ツリーの展開状態（Panel の作り直しで消さない）
 *   GitDraftProvider        … Git の Commit message 下書き（Panel の作り直しで消さない）
