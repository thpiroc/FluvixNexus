...
describe('UI ラベル（Keyboard Shortcuts の画面）', () => {
  const LABEL_KEYS = [
    ...
    'settings.keyboard.editNote',
    'settings.keyboard.modified',
    'settings.keyboard.actions.change',
    'settings.keyboard.actions.assign',
    'settings.keyboard.actions.remove',
    'settings.keyboard.actions.reset',
    'settings.keyboard.actions.resetAll',
    'settings.keyboard.actions.resetAllConfirm',
    'settings.keyboard.actions.confirm',
    'settings.keyboard.actions.cancel',
    'settings.keyboard.recorder.label',
    'settings.keyboard.recorder.prompt',
    'settings.keyboard.recorder.hint',
    'settings.keyboard.recorder.notAssignable',
    /* Shortcuts S5：警告と読めない項目。 */
    'settings.keyboard.warnings.label',
    'settings.keyboard.warnings.commandSeparator',
    'settings.keyboard.warnings.conflict.overridden',
    'settings.keyboard.warnings.conflict.wins',
    'settings.keyboard.warnings.conflict.loses',
    'settings.keyboard.warnings.preview.overridden',
    'settings.keyboard.warnings.preview.wins',
    'settings.keyboard.warnings.preview.loses',
    'settings.keyboard.warnings.reserved.textEditing',
    'settings.keyboard.warnings.reserved.editorFind',
    'settings.keyboard.warnings.reserved.terminalFontSize',
    'settings.keyboard.warnings.reserved.terminalClipboard',
    'settings.keyboard.warnings.reserved.terminalSubmit',
    'settings.keyboard.warnings.reserved.gitCommit',
    'settings.keyboard.warnings.reserved.filesRename',
    'settings.keyboard.warnings.reserved.commandPalette',
    'settings.keyboard.warnings.reserved.imeToggle',
    'settings.keyboard.warnings.reserved.windowClose',
    'settings.keyboard.invalid.title',
    'settings.keyboard.invalid.note',
    'settings.keyboard.invalid.skipped',
    'settings.keyboard.invalid.problems.unknownCommand',
    'settings.keyboard.invalid.problems.invalidKey',
    'settings.keyboard.invalid.problems.whenNotSupported',
    'settings.keyboard.resetAllConfirm',
    'settings.keyboard.saveFailed',
    'settings.keyboard.loadFailed',
    'settings.keyboard.unreadableNote',
    /* Shortcuts S2：組み込みの行（端末の文字の大きさも行として並ぶので terminalNote は無い）。 */
    ...
    'settings.keyboard.builtin.scopes.terminalNormal',
    'settings.keyboard.builtin.scopes.terminalAiCli',
